...
Then('the registration page should be displayed', async function () {
    ...
    if (!displayed) {
        ...
        throw new Error(
            'Registration page was not displayed'
        );
...
Then('the registration form fields should be displayed', async function () {
    ...
    if (!await RegistrationPage.isPasswordFieldDisplayed()) {
        ...
        throw new Error(
            'Password field was not displayed'
        );
...
When('I confirm the registration', async function () {
    ...
    if (!displayed) {
        ...
        throw new Error(
            'Organization page was not displayed after registration'
        );
